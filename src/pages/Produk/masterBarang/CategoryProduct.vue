            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title clearfix">
                        <h4 class="float-left">Kategori Produk</h4>
                        <div class="add-actions float-right" v-if="$dataRole['category_product.create']">
                    ...
                    <div>
                        ...
                        <div class="" v-if="itemsData">
                            ...
                            <el-table 
                                ...
                                v-loading="loading"
                                class="mobayar-table">
                                <el-table-column type="selection" width="55" v-if="$dataRole['category_product.delete']"></el-table-column>
                            ...
                            <div class="base-template-sidebar">
                                ...
                                <div class="actions-button clearfix">
                                    <el-button v-if="$dataRole['category_product.delete']" v-show="(formsType == 'edit')" class="button-outline-black" id="trash" @click.prevent="deletePost('once', itemDataDetail.id)">
                                    ...
                                    <el-button v-if="$dataRole['category_product.edit']" v-show="(formsType == 'edit')" class="button-white-green" id="save-edit" @click.prevent="submitSave('formsvalid', 'edit')">Simpan</el-button>
...
<script>
    ...
    export default {
        ...
        created(){
            FUNCTIONS.checkPermissions(this.$dataRole['category_product.list'])
        },
        mounted () {
        ...
        methods: {
                        ...
                        if(formtype == 'save'){
                            ...
                            .then(response => {
                                ...
                                if(response.data.status == 'error'){
                                    ...
                                    this.messagesuccess = "Kategory Produk Berhasil ditambahkan."
                                    this.getPosts(this.perPage, this.currentPage, '')
                                    this.closeModal();
                                }
                            })
                            ...
                            .then(response => {
                                ...
                                if(response.data.status == 'error'){
                                    ...
                                    this.messagesuccess = "Kategory Produk Berhasil diubah."
                                    this.getPosts(this.perPage, this.currentPage, '')
                                    this.closeModal();
                                }
                            })
            ...
            deletePost(type, valueid){
                ...
                if(type == 'all'){
                    ...
                    if(this.itemiDforDelete.length <= 5){
                        this.$confirm('Apakah anda yakin akan menghapus '+ id.length +' item dari daftar?', 'Hapus Kategory Produk', {
                    ...
                    this.$confirm('Apakah anda yakin akan menghapus item dari daftar?', 'Hapus Kategory Produk', {
                        confirmButtonText: 'OK',
                        cancelButtonText: 'Cancel',
                        type: 'warning'
                    }).then(() => {
            ...
            Create(){
                this.titleForms = "Kategori Produk Baru"
