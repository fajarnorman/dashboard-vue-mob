...
<script>
    ...
    export default {
        ...
        created(){
            FUNCTIONS.checkPermissions(this.$dataRole['report.balance.mutation'])
        },
        data () {
            return {
                // for get api
        ...
        methods: {
                                        ...
                                        exportToExcel.push(
                                            {
                                                ...
                                                'Saldo' : parseInt(currentValue.amount),
                                            }
                                        )
                                    })
            ...
            getUserAll(search){
                let userDataurl = this.apiURL + this.sectionApiUser + '?limit=20&direction=ASC&order=fullname&page=1&username=' + search
