            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title clearfix">
                        <h4 class="float-left">Agent Top Up</h4>
                        <div class="add-actions float-right">
                            <a @click.prevent="Create" href="#" v-if="$dataRole['agent.topupcreate']">
                                                    ...
                                                    <el-row :gutter="20">
                                                        ...
                                                        <el-col :span="12">
                                                            <el-form-item label="Jenis">
                                                                <el-switch v-model="forms.bonus"></el-switch> Bonus
                                                            </el-form-item>
                                                        </el-col>
                                                    </el-row>
                                                </div>
    ...
    export default {
        ...
        methods:{
            ...
            handleCurrentChange(val){
                if(this.$dataRole['agent.topupdetail']){
                    if(val){
                        ...
                        .then(response => {
                            ...
                            this.titleForms = 'Agen Topup Detail - ' + this.itemDataDetail.user.fullname
                        })
                        .catch(error => { 
                            console.log(error);
                            this.errored = true
            ...
            Create(){
                this.titleForms = "Top Up Agen Baru"
                            ...
                            if(this.userValue == ''){
                                ...
                                .then(response => {
                                    ...
                                    if(response.data.status == 'error'){
                                        ...
                                        this.messagesuccess = "Penambahan saldo berhasil disimpan"
                                        this.getPosts('', this.startDate[0], this.startDate[1])
                                        this.closeModal();
                                    }
                                })
