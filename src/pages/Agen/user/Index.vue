            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title clearfix">
                        <h4 class="float-left">User List : {{dataRole}}</h4>
                        <div class="add-actions">
                            <a @click.prevent="Create" class="float-right" v-if="$dataRole['user.create']">
                ...
                <section v-else>
                    <div>
                        <div class="filterSearching clearfix">
                            ...
                            <el-select v-model="roleQuery" placeholder="Filter by Role">
                                <el-option 
                                    v-for="(dataRole, indexRole) in itemsDataPermission"
                                    :key="indexRole"
                                    :value="dataRole.id" 
                                    :label="dataRole.name">{{dataRole.name}}</el-option>
                            </el-select>
                        </div>
                        <div class="" v-if="itemsData">
                            ...
                            <el-table 
                                ...
                                v-loading="loading"
                                class="mobayar-table">
                                <el-table-column type="selection" width="55" v-if="$dataRole['user.delete']"></el-table-column>
                            ...
                            <div class="base-template-sidebar">
                                ...
                                <div class="content">
                                    ...
                                    <section>
                                        ...
                                        <el-button class="manage-point button-white-green float-right" @click="dialogVisible = true" v-if="formsType == 'edit' && TabsActive == 'info'">
                                            <img src="~assets/images/icons/gear-white.png">Manage Point
                                        </el-button>
                                        <el-tabs v-model="TabsActive" class="float-left tabs-device" style="width:100%;">
                                            <el-tab-pane label="General Info" name="info">
                                                            ...
                                                            <el-row :gutter="20">
                                                                ...
                                                                <el-col :span="12">
                                                                    <el-form-item label="Tanggal Lahir" prop="birthdate">
                                                                        <el-date-picker autocomplete="off" v-model="forms.birthdate" type="date" format="d-MM-yyyy"></el-date-picker>
                                                                    </el-form-item>
                                                                </el-col>
                                                                <el-col :span="24">
                                                            ...
                                                            <el-row :gutter="20">
                                                                ...
                                                                <el-col :span="12">
                                                                    <el-form-item label="Role" prop="role">
                                                                        <el-select v-model="forms.role" placeholder="Select" v-if="(formsType != 'edit')">
                                                                            <el-option 
                                                                                v-for="(dataFieldRole, indexFieldRole) in itemsDataPermission"
                                                                                :key="indexFieldRole"
                                                                                :value="dataFieldRole.id" 
                                                                                :label="dataFieldRole.name">{{dataFieldRole.name}}</el-option>
                                                                        </el-select>
                                                                        <el-select v-model="forms.role" placeholder="Select" v-else>
                                                                            <el-option 
                                            ...
                                            <el-tab-pane label="Device" name="device" v-if="formsType == 'edit'">
                                                <div class="device-content">
                                                    <div class="filterSearching clearfix">
                                                        <div class="input-with-icons clearfix">
                                                            <el-input v-model="searchDevice" class="float-left" placeholder="Search by Imei"></el-input>
                                                            <img src='~assets/images/icons/search1.png'>
                                                        </div>
                                                    </div>
                                                    <el-table 
                                                        ...
                                                        class="mobayar-table">
                                                        <el-table-column prop="device_token" label="Device Token" width="250"></el-table-column>
                                                        <el-table-column prop="imei" label="Imei" width="180"></el-table-column>
                                                        <el-table-column prop="app_version" label="App Version" align="center" width="120"></el-table-column>
                                                        <el-table-column label="Status" align="center" width="120">
                                                            <template slot-scope="scope">
                                                                <div v-if="scope.row.status == 1">
                                                                    <span class="badge success inline">Active</span>
                                                                </div>
                                                                <div v-else>
                                                                    <span class="badge failed inline">Inactive</span>
                                                                </div>
                                                            </template>
                                                        </el-table-column>
                                            ...
                                            <el-tab-pane label="Device Logs" name="device_logs" v-if="formsType == 'edit'">
                                                <div class="device-content">
                                                    <div class="filterSearching clearfix">
                                                        <div class="input-with-icons clearfix">
                                                            <el-input v-model="searchDeviceLogs" class="float-left" placeholder="Search by Imei"></el-input>
                                                            <img src='~assets/images/icons/search1.png'>
                                                        </div>
                                                    </div>
                                                    <el-table 
                                                        ...
                                                        ref="deviceTable"
                                                        highlight-current-row
                                                        v-loading="loadingDeviceLog"
                                                        class="mobayar-table">
                                                        <el-table-column prop="device_token" label="Device Token" width="250"></el-table-column>
                                                        <el-table-column prop="imei" label="Imei" width="180"></el-table-column>
                                                        <el-table-column prop="app_version" label="App Version" align="center" width="120"></el-table-column>
                                                        <el-table-column prop="type" label="Type" width="120"></el-table-column>
                                                        <el-table-column prop="created_at" label="Logged At" width="180"></el-table-column>
                                                    </el-table>
                                                </div>
                                            </el-tab-pane>
                                        </el-tabs>
                                ...
                                <div class="actions-button clearfix" v-if="TabsActive == 'info'">
                                    <el-button v-show="(formsType == 'edit')" v-if="$dataRole['user.delete']" class="button-outline-black" id="trash" @click.prevent="deletePost('once', itemDataDetail.id)">
                                    ...
                                    <el-button v-show="(formsType == 'edit')" v-if="$dataRole['user.edit']" class="button-white-green" id="save-edit" @click.prevent="submitSave('formsvalid', 'edit')">Simpan</el-button>
                                                ...
                                                <el-tabs v-model="activeTabs">
                                                    ...
                                                    <el-tab-pane label="Reduce Point" name="reduce">
                                                        <div class="tabs-managePoint forms-details">
                                                            ...
                                                            <el-form-item label="Input Point">
                                                                <el-input v-model="forms.points" type="number" class="customvalinum"></el-input>
...
<script>
    ...
    export default {
        ...
        created () {
            FUNCTIONS.checkPermissions(this.$dataRole['user.list'])
        },
        mounted () {
            // Get all Post user
            this.getPosts(this.perPage, this.currentPage, '', this.filterQuery, this.role)
        ...
        watch: {
            ...
            filterQuery: function(newFilter){
                if(this.roleQuery == ''){
                    this.getPosts(this.perPage, this.currentPage, this.searchQuery, newFilter, this.role)
                    document.querySelector('.el-pagination').children[1].children[0].click()
                }else{
                    this.getPosts(this.perPage, this.currentPage, this.searchQuery, newFilter, this.roleQuery)
                    document.querySelector('.el-pagination').children[1].children[0].click()
                    // if(newFilter == )
                }
            },
            roleQuery: function(newRole){
                document.querySelector('.el-pagination').children[1].children[0].click()
                this.getPosts(this.perPage, this.currentPage, this.searchQuery, this.filterQuery, newRole)
                this.dataRole = newRole
                if(newRole == 1){
                    this.dataRole = "Super Admin"
                }else if(newRole == 2){
                    this.dataRole = "Admin"
                }else if(newRole == 3){
                    this.dataRole = "Customer Service"
                }else if(newRole == 6){
                    this.dataRole = "Kepala SPK"
                }else if(newRole == 7){
                    this.dataRole = "Admin DGW"
                }else if(newRole == 8){
                    this.dataRole = "Admin Regional"
                }
            },
            searchDeviceLogs: function(newValue){
                let that = this
                setTimeout(function(){
                    that.gerPostDeviceLogs(that.deviceLogsId)
                }, 500)
            },
        ...
        methods: {
            // build url function
            buildUrl (limit, page, search, status, role) {
                return this.apiUrl + this.sectionApi + "?limit=" + limit + "&page=" + page + '&search=' + search + '&role=' + role + '&status=' + status
            },
            ...
            // get all post
            getPosts(num, pg, sch, sts, rol){
                let url = this.buildUrl(num, pg, sch, sts, rol)
                this.loading = true
                this.axios.get(url)
                .then(response => {
            ...
            getPostDevice(id){
                let url = this.apiUrl + this.sectionApi + '/' + id + '/devices'
                this.loadingDevice = true
                this.axios.get(url)
                .then(response => {
                    if(response.data.status == 'success'){
                        this.itemsDevice = response.data.data
            ...
            gerPostDeviceLogs(id){
                this.deviceLogsId = id
                let url = this.apiUrl + this.sectionApi + '/deviceLogs?user_id=' + this.deviceLogsId + '&limit=10&page=1&direction=DESC&search=' + this.searchDeviceLogs
                this.loadingDeviceLog = true
                this.axios.get(url)
                .then(response => {
                    if(response.data.status == 'success'){
                        this.itemsDeviceLog = response.data.data
                        this.loadingDeviceLog = false
                    }
            ...
            getRolePermission(){
                ...
                this.axios.get(url)
                .then(response => {
                    let arrayPermission = response.data.data
                    arrayPermission.forEach(function(element){
                        if(element.id != '4' && element.id != '5'){
                            this.itemsDataPermission.push(element)        
                        }

                        this.itemsDataPermissionAll.push(element)
                    }, this)
                })
                .catch(error => { 
                    console.log(error);
            ...
            pageChange (page) {
                ...
                if(this.roleQuery == ''){
                    this.getPosts(this.perPage, this.currentPage, this.searchQuery, this.filterQuery, this.role)
                }else{
                    this.getPosts(this.perPage, this.currentPage, this.searchQuery, this.filterQuery, this.roleQuery)
                }
            },
            ...
            deletePost(type, valueid){
                if(type == 'all'){
                    ...
                    this.$confirm('Anda yakin akan menghapus '+ id.length +' dari daftar staff?', 'Hapus User', {
                        ...
                        for(let i = 0; i< id.length; i++){
                            ...
                            .then(response => {
                                if(this.roleQuery == ''){
                                    ...
                                    this.getPosts(this.perPage, this.currentPage, '', this.filterQuery, this.roleQuery)
                                }
                            })
                            .catch(error => { 
                                console.log(error);
                    ...
                    this.$confirm('Anda yakin akan menghapus '+ this.itemDataDetail.fullname +' dari daftar staff?', 'Hapus User', {
                        confirmButtonText: 'OK',
                        cancelButtonText: 'Cancel',
                        type: 'warning'
                    }).then(() => {
            ...
            handleCurrentChange(val){
                if(this.$dataRole['user.show']){
                    if(val){
                        ...
                        this.forms.old_role = val.role_id
                        this.forms.role = val.role_id
            ...
            getDetailPost(id, value){
                ...
                .finally(() => {
                    ...
                    this.getPostDevice(id)
                    this.gerPostDeviceLogs(id)
                })
            },
