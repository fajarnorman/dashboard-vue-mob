    ...
    <div class="content-wrapper">
        <div id="master-barang-attribute">
            <div class="page-header">
                <page-header titleName="SMS Provider" :isCreate="$dataRole['service.notification.post.sms.provider']"></page-header>
            </div>
            <div class="content">
                ...
                <div class="base-template-sidebar">
                                        ...
                                        <el-row :gutter="20">
                                            <el-col :span="24">
                                                <el-form-item label="Base Url" prop="base_url">
                                                    <el-input v-model="forms.base_url"></el-input>
                                                </el-form-item>
                                            </el-col>
                                            <el-col :span="24">
                                            ...
                                            <el-col :span="24" v-if="formsType == 'edit'">
                    ...
                    <div class="actions-button clearfix">
                        <el-button v-if="$dataRole['service.notification.delete.sms.provider.*']" v-show="(formsType == 'edit')" class="button-outline-black" id="trash" @click.prevent="deletePost(itemDataDetail.id)">
                        ...
                        <el-button v-if="$dataRole['service.notification.put.sms.provider.*']" v-show="(formsType == 'edit')" class="button-white-green" id="save-edit" @click.prevent="submitSave('formsvalid', 'edit')">Simpan</el-button>
...
export default {
    name: 'notify-smsProvider',
    data(){
        var linkValidatorsProvider = (rule, value, callback) => {
        ...
        return{
            sectionApi: 'notification?servicePathUrl=sms/provider',
            loading: false,
            loadingForm: false,
            itemsData: [],
            itemDataDetail: [],
            ...
            messagesuccess: '',
            messageerror: '',
            dataTextCreate: 'Buat Provider Baru',
            dataTextUpdate: 'Edit Provider',
            confirmDescDelete: 'Anda yakin akan menghapus data Provider dari daftar?',
            confirmTitleDelete: 'Hapus Provider',
            textDataCreateSuccess: 'Data Provider Berhasil ditambahkan.',
            textDataUpdateSuccess: 'Data Provider Berhasil diupdate.',
            ...
            rules:{
                base_url: [ { required: true, message: 'Inputan Harus diisi', trigger: 'blur' } ],
    ...
    created(){
        ...
        FUNCTIONS.checkPermissions(this.$dataRole['service.notification.get.sms.provider'])
    },
    mounted(){
    ...
    methods:{
        ...
        handleCurrentChange(val){
            if(val){
                ...
                this.forms.base_url = this.itemDataDetail.base_url
