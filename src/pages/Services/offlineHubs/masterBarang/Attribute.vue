    ...
    <div class="content-wrapper">
        <div id="master-barang-attribute">
            <div class="page-header">
                <page-header titleName="Attribute Offline Hub" :isCreate="$dataRole['service.offlinehub.post.attribute.create']"></page-header>
            </div>
            <div class="content">
                ...
                <div class="base-template-sidebar">
                    ...
                    <div class="actions-button clearfix">
                        <el-button v-if="$dataRole['service.offlinehub.delete.attribute.delete.*']" v-show="(formsType == 'edit')" class="button-outline-black" id="trash" @click.prevent="deletePost(itemDataDetail.id)">
                        ...
                        <el-button v-if="$dataRole['service.offlinehub.put.attribute.update.*']" v-show="(formsType == 'edit')" class="button-white-green" id="save-edit" @click.prevent="submitSave('formsvalid', 'edit')">Simpan</el-button>
...
export default {
    ...
    data(){
        ...
        var validateCode2 = (rule, value, callback) => {
            if (value === '') {
                ...
                if (/^[a-zA-Z0-9- ,_]*$/.test( this.forms.value ) == false) {
        ...
        return{
            sectionApi: 'offlinehub?servicePathUrl=attribute',
            loading: false,
            loadingForm: false,
            itemsData: [],
            itemDataDetail: [],
            ...
            dataTextUpdate: 'Edit Attribute Barang Offline Hub',
    ...
    created(){
        FUNCTIONS.checkPermissions(this.$dataRole['service.offlinehub.get.attribute'])
    },
    mounted(){
    ...
    methods:{
        ...
        handleCurrentChange(val){
            if(this.$dataRole['service.offlinehub.get.attribute.detail.*']){
                if(val){
